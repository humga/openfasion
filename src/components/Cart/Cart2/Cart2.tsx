...
import classes from './Cart2.module.css';
...
interface Props {
  ...
  text?: {
    lamerei?: ReactNode;
    recycleBoucleKnitCardiganPink?: ReactNode;
  };
}
/* @figmaId 700:1478 */
export const Cart2: FC<Props> = memo(function Cart2(props = {}) {
  return (
    <div className={`${resets.clapyResets} ${props.classes?.root || ''} ${props.className || ''} ${classes.root}`}>
      ...
      <div className={`${props.classes?.frame27 || ''} ${classes.frame27}`}>
        <div className={classes.frame14}>
          {props.text?.lamerei != null ? props.text?.lamerei : <div className={classes.lamerei}>lamerei</div>}
          {props.text?.recycleBoucleKnitCardiganPink != null ? (
            props.text?.recycleBoucleKnitCardiganPink
          ) : (
